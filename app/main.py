from services.triaje import calcular_prioridad
...
color_prioridad, prioridad = calcular_prioridad()
print(f"El usuario {paciente1.nombre} {paciente1.apellido} tiene un color de prioridad {color_prioridad} con puntaje {prioridad}")
